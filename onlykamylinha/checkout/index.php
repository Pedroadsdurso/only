...
define('AtivoPay_secretKey', 'sk_live_wZsIKn1xiwxatqCIDtuO0fEKJbtYI00MX7EsunNERp'); // Secret Key da Cashtime
...
function gerar_pix_gtw()
{
    ...
    if (isset(explode('"qrcode":"', $response)[1]) && explode('"qrcode":"', $response)[1] != '') {
        ...
        return ['pix_qr' => $rsp_pix_qr, 'pix_copia' => $rsp_pix_copia];
    } else {
        return false;
    }
                        ...
                        <img
                           ...
                           alt="qrcode">
                            ...
                            <button type="button"
                                ...
                                onclick="copyToClipboard()" id="btn_copiar">
                                Copiar código
